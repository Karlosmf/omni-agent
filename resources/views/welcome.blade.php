...
<head>
    ...
    @endif
    <link rel="icon" href="{{ asset('images/branding/logo-icon.png') }}" />
</head>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-xl">Luopan Viajes & Turismo</h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                    Luopan, más que una agencia, tu compañera de viajes.
                </p>

                <div class="mb-6 space-y-2 text-[#706f6c] dark:text-[#A1A09A]">
                    <p class="flex items-center gap-2">
                        ...
                        Belgrano 843, Local A, Reconquista, Santa Fe 3560
                    </p>
                    <p class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-4 h-4">
                    ...
                    <p class="flex items-center gap-2">
                        ...
                        8:30 a 12:30 hs - 16:00 a 20:00 hs
                    </p>
                </div>

                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://share.google/Aots6fOVDiIKJVTIg" target="_blank"
            ...
            <div
                ...
                <div class="w-full flex justify-center items-center py-10 lg:py-20">
                    <img src="{{ asset('images/branding/logo-full.png') }}" alt="Logo"
                        class="max-w-[80%] h-auto dark:invert lg:max-w-[60%]">
                </div>
