...
abstract class ParserAbstract implements Parser
{
    ...
    /** @var int[] Table indexed analogously to. IfCheck[$actionBase[$state] +] !=
    ...
    /** @var int[] Table indexed analogously to. IfCheck[$gotoBase[$nonTerminal] +] !=
     ...
     * @return Stmt[]|null Array of statements (or null non-throwing error handler is used and
    ...
    */
    ...
    protected function handleNamespaces(array $stmts): array
    {
        ...
        if ($style === 'brace') {
            ...
            foreach ($stmts as $stmt) {
                ...
                } elseif (! $stmt instanceof Stmt\HaltCompiler
                        && ! $stmt instanceof Nop
    ...
    private function fixupNamespaceAttributes(Namespace_ $stmt): void
    {
    ...
    private function getNamespacingStyle(array $stmts): ?string
    {
        ...
        foreach ($stmts as $i => $stmt) {
            ...
            if ($stmt instanceof Stmt\Declare_
                || $stmt instanceof Stmt\HaltCompiler
                || $stmt instanceof Nop) {
                continue;
            }

            /* There may be a hashbang line at the very start of the file */
            if ($i === 0 && $stmt instanceof Stmt\InlineHTML && preg_match('/\A#!.*\r?\n\z/', $stmt->value)) {
                continue;
            }
    ...
    protected function handleBuiltinTypes(Name $name)
    {
        ...
        return new Identifier($lowerName, $name->getAttributes());
    }
    ...
    protected function parseDocString(
        ...
        if (\is_string($contents)) {
            ...
            if (! $contents[0] instanceof InterpolatedStringPart) {
    ...
    protected function inlineHtmlHasLeadingNewline(int $stackPos): bool
    {
        ...
        if ($tokenPos > 0) {
            ...
            return strpos($prevToken->text, "\n") !== false
                || strpos($prevToken->text, "\r") !== false;
        }
