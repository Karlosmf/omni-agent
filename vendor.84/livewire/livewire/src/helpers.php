...
function store($instance = null)
{
    ...
    return new class($instance)
    {
        ...
        {
            return app(DataStore::class)->get($this->instance, $key, $default);
        }

        public function set($key, $value)
        {
            return app(DataStore::class)->set($this->instance, $key, $value);
        }

        public function push($key, $value, $iKey = null)
        {
            return app(DataStore::class)->push($this->instance, $key, $value, $iKey);
        }

        public function find($key, $iKey = null, $default = null)
        {
            return app(DataStore::class)->find($this->instance, $key, $iKey, $default);
        }

        public function has($key, $iKey = null)
        {
            return app(DataStore::class)->has($this->instance, $key, $iKey);
        }

        public function unset($key, $iKey = null)
        {
            return app(DataStore::class)->unset($this->instance, $key, $iKey);
        }
    };
}
