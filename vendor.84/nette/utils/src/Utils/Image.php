...
class Image
{
    ...
    /** image types */
    public const JPEG = ImageType::JPEG;

    public const PNG = ImageType::PNG;

    public const GIF = ImageType::GIF;

    public const WEBP = ImageType::WEBP;

    public const AVIF = ImageType::AVIF;

    public const BMP = ImageType::BMP;
