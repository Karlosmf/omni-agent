...
class PhpDocParser
{
    ...
    private function parseMethodTagValue(TokenIterator $tokens): Ast\PhpDoc\MethodTagValueNode
    {
        ...
        if ($staticKeywordOrReturnTypeOrMethodName instanceof IdentifierTypeNode && $staticKeywordOrReturnTypeOrMethodName->name === 'static') {
            $isStatic = true;
        ...
        } elseif ($returnTypeOrMethodName instanceof IdentifierTypeNode) {
