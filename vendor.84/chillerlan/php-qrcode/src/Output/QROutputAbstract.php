...
abstract class QROutputAbstract implements QROutputInterface
{
    ...
    /** @see QROptions::$connectPaths */
    protected bool $connectPaths;

    /** @see QROptions::$excludeFromConnect */
    protected array $excludeFromConnect;

    /** @see QROptions::$eol */
    protected string $eol;

    /** @see QROptions::$drawLightModules */
    protected bool $drawLightModules;

    /** @see QROptions::$drawCircularModules */
    protected bool $drawCircularModules;

    /** @see QROptions::$keepAsSquare */
    protected array $keepAsSquare;

    /** @see QROptions::$circleRadius */
     ...
     * @see QROutputAbstract::moduleTransform()
     */
