...
trait QROptionsTrait
{
     ...
     *
     * @see QROutputAbstract::collectModules()
     * @see QROptionsTrait::$excludeFromConnect
     ...
     *
     * @see QROptionsTrait::$connectPaths
     */
     ...
     * - `QREps`: `[C, M, Y, K]` // 0-255
     *
     * @see QROutputAbstract::setModuleValues()
     */
     ...
     *
     * @see QRCode::addMatrixModifications()
     * @see QRMatrix::setLogoSpace()
     */
     ...
     * @see        QROptions::$transparencyColor
     */
